...
class _EventsScreenState extends State<EventsScreen> {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Expanded(flex: 2, child: ElevatedButton(onPressed: _startFeverVetFlow, child: _iconLabel(Icons.check, 'Yes, fever'))),
                ],
              ),
            ],
          ),
  ...
  Widget _buildHeatCard(bool isDark) {
    ...
    return _ActionCard(
      ...
      photoTitleOverride: _heatConfirmed ? 'Insemination window' : null,
      photoBodyOverride: _heatConfirmed ? _heatEvolvingBody(h, label, color, isDark) : null,
      child: Padding(
        padding: const EdgeInsets.only(top: 12),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
