...
final List<FarmModel> kFarms = [
  FarmModel(
    ...
    cows: [
      const CowModel(name: 'Gowri', nameHi: 'गौरी', no: 1, age: '2.2 yrs', ageHi: '2.2 साल', belt: 'Belt 60', beltHi: 'बेल्ट 60', breed: 'Jersey', breedHi: 'जर्सी', status: 'Milking', temp: '32°C', trend: 'up', photo: 'assets/images/cows/gowri.jpg', info: [
        InfoCell('labelMilkToday', '12 L'), InfoCell('labelLastMilking', '6:45 AM'), InfoCell('labelLactation', 'Day 45', valueHi: 'दिन 45')]),
      const CowModel(name: 'Giri', nameHi: 'गिरि', no: 2, age: '4 yrs', ageHi: '4 साल', belt: 'Belt 12', beltHi: 'बेल्ट 12', breed: 'HF Cross', breedHi: 'एचएफ क्रॉस', status: 'Pregnant', temp: '34°C', trend: 'up', photo: 'assets/images/cows/giri.jpg', info: [
      ...
      const CowModel(name: 'Ramya', nameHi: 'रम्या', no: 3, age: '3 yrs', ageHi: '3 साल', belt: 'Belt 45', beltHi: 'बेल्ट 45', breed: 'Gir', breedHi: 'गिर', status: 'Heat', temp: '36°C', trend: 'up', photo: 'assets/images/cows/ramya.jpg', info: [
      ...
      const CowModel(name: 'Nandini', nameHi: 'नंदिनी', no: 5, age: '2.8 yrs', ageHi: '2.8 साल', belt: 'Belt 22', beltHi: 'बेल्ट 22', breed: 'Ongole', breedHi: 'ओंगोल', status: 'Milking', temp: '31°C', trend: 'down', photo: 'assets/images/cows/nandini.jpg', info: [
  ...
  FarmModel(
    ...
    cows: [
      const CowModel(name: 'Meera', nameHi: 'मीरा', no: 1, age: '3.5 yrs', ageHi: '3.5 साल', belt: 'Belt 21', beltHi: 'बेल्ट 21', breed: 'Jersey', breedHi: 'जर्सी', status: 'Milking', temp: '31°C', trend: 'up', photo: 'assets/images/cows/chinnu.jpg', info: [
        InfoCell('labelMilkToday', '11 L'), InfoCell('labelLastMilking', '7:00 AM'), InfoCell('labelLactation', 'Day 80', valueHi: 'दिन 80')]),
      const CowModel(name: 'Kaveri', nameHi: 'कावेरी', no: 2, age: '2 yrs', ageHi: '2 साल', belt: 'Belt 8', beltHi: 'बेल्ट 8', breed: 'Desi', breedHi: 'देसी', status: 'Milking', temp: '32°C', trend: 'up', photo: 'assets/images/cows/kaveri.jpg', info: [
  ...
  FarmModel(
    ...
    heat: 0, fever: 0, insem: 0, preg: 1, temp: '30°C', status: FarmStatus.healthy,
    cows: [
      const CowModel(name: 'Chinnu', nameHi: 'चिन्नू', no: 1, age: '5 yrs', ageHi: '5 साल', belt: 'Belt 3', beltHi: 'बेल्ट 3', breed: 'Gir', breedHi: 'गिर', status: 'Milking', temp: '30°C', trend: 'up', photo: 'assets/images/cows/chinnu.jpg', info: [
